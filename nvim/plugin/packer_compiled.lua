...
_G.packer_plugins = {
  ...
  ["null-ls.nvim"] = {
    config = { "\27LJ\2\n9\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\30settings.null-ls.settings\frequire\0" },
    loaded = true,
  ...
  ["telescope.nvim"] = {
    after = { "telescope-zoxide", "nvim-neoclip.lua", "telescope-project.nvim", "telescope-file-browser.nvim" },
...
try_loadstring("\27LJ\2\n9\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\30settings.null-ls.settings\frequire\0", "config", "null-ls.nvim")
