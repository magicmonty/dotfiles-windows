return {
  ...
  config = function()
    ...
    map('n', '<leader>bn', '<cmd>BufferNext<cr>', silent)
    map('n', '<leader>bmk', '<cmd>BufferMoveNext<cr>', silent)
    map('n', '<leader>bmn', '<cmd>BufferMoveNext<cr>', silent)
    map('n', '<leader>bj', '<cmd>BufferPrevious<cr>', silent)
    map('n', '<leader>bp', '<cmd>BufferPrevious<cr>', silent)
    map('n', '<leader>bmj', '<cmd>BufferMovePrevious<cr>', silent)
    map('n', '<leader>bmp', '<cmd>BufferMovePrevious<cr>', silent)
