...
dap.adapters.vsdbg = {
  type = 'executable',
  command = vim.fn.expand('C:/Users/mgondermann/.vscode/extensions/ms-dotnettools.csharp-1.23.16/.debugger/vsdbg-ui.exe'),
  options = {
    env = {
      ASPNETCORE_ENVIRONMENT = "Development",
      cwd = "${workspaceFolder}"
...
fn.sign_define('DapBreakpoint', {text='', texthl='DebugBreakpointSign', linehl='DebugBreakpointLine', numhl=''})
