...
; Open/Activate Windows Terminal (Win + T)
^ö::
  Process, Exist, WindowsTerminal.exe ; check to see if Windows Terminal is running
    {
      If ! ErrorLevel
        Run, "wt.exe"
      Else
...
:*R:ilb::/* intentionally left blank */
:*:shrug::¯\_(ツ)_/¯
:*R:--->::→

:*:bump::
InputBox, VersionsNummer, Versionsnummer, Versionsnummer,,174,139
text = Bump version to %VersionsNummer%`r`n`r`n[ci-skip]
